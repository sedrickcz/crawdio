module Refinery
  module Projects
    class Project < Refinery::Core::BaseModel
      ...
      attr_accessible :title, :short_description, :long_description, :goal, :main_image_id, :image_1_id, :image_2_id, :image_3_id, :image_4_id, :image_5_id, :active, :video, :faq, :terms, :updates, :position
