module Refinery
  module Tiers
    class Tier < Refinery::Core::BaseModel
      ...
      attr_accessible :title, :price, :limit, :physical, :short_description, :long_description, :active, :image_1_id, :image_2_id, :image_3_id, :project_id, :position, :platform_1, :platform_2, :tshirt, :ingame_name, :sword_legal, :side_text
